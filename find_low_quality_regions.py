...
def find_undercovered_positions(coverage_matrix, samplename = "unknown_sample", dp_cutoff = None, whitelist_filename = None):
...
def find_strandbiased_positions(coverage_matrix, samplename = "unknown_sample", max_strand_ratio = None, whitelist_filename = None):    
...
def run(bed, target_folder):
    ...
    for bam in bams:
        ...
        find_undercovered_positions(coverage_matrix, samplename= samplename, dp_cutoff = dp_cutoff)
